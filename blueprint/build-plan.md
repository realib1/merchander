...
- [ ] 28. **Merchant Self-Service Onboarding & Business Customizer** - public `/signup` wizard, business model archetypes (grocery, import, boutique), dynamic module gating across dashboard and sidebar, and in-app module management.
- [ ] 29. **UI Form Modernization & Code Quality Audit (Drawer vs Modal & LOC Refactor)** - systematic audit and refactoring across platform and merchant dashboard: migrate long multi-section creation and editing forms from centered modals to accessible right-hand slide-over `Drawer` components, decompose oversized components violating single-responsibility and LOC rules, eliminate any loose types or `any` assertions, and remove stray em dashes and anti-patterns.
