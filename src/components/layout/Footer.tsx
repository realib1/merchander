...
export const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer
      className={cn(
        "w-full border-t border-[var(--color-border)] bg-[var(--color-surface)] text-[var(--color-text-secondary)] transition-colors duration-[var(--duration-fast,150ms)]",
        className
      )}
    >
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 md:grid-cols-12">
          ...
          <div className="flex flex-col gap-3 md:col-span-4 lg:col-span-5">
            <div className="flex items-center gap-2 mb-2">
              ...
              />
                <span className="text-xl font-bold tracking-tight text-[var(--color-text-primary)] font-display">
                  Merchander
                </span>
            </div>
            {tagline && (
                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      className="inline-flex h-8 w-8 items-center justify-center rounded-[var(--radius-sm,4px)] text-[var(--color-text-muted)] transition-colors hover:bg-[var(--color-surface-elevated)] hover:text-[var(--color-text-primary)]"
                    >
        ...
        {/* Bottom bar */}
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-[var(--color-border)]/60 pt-8 text-xs text-[var(--color-text-muted)] sm:flex-row">
