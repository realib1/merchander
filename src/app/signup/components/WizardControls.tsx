  ...
  return (
    <div className="mt-8 pt-6 border-t border-separator flex items-center justify-between">
      <button
        ...
        className="inline-flex items-center gap-1.5 px-4 py-2 text-sm font-semibold rounded-xl border border-separator transition-all text-foreground hover:bg-surface-elevated cursor-pointer disabled:opacity-50"
      >
        <ChevronLeft size={16} />
        <span>Back</span>
      </button>
