    ...
    <div className="flex h-screen bg-slate-900 text-slate-100">
      ...
      <aside className="w-64 bg-slate-950 border-r border-slate-800 flex flex-col hidden md:flex">
        <div className="p-6 border-b border-slate-800">
          ...
          <div className="text-xs text-slate-500 font-medium tracking-wider mt-1">
            PLATFORM ADMIN
          </div>
        </div>

        <nav className="flex-1 px-4 space-y-1 mt-4">
          <Link href="/superadmin" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition-colors font-medium">
            <Users size={20} />
            Tenants
          </Link>
          <Link href="/superadmin/infrastructure" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-slate-300 hover:bg-slate-800 hover:text-white transition-colors font-medium mt-1">
            <Database size={20} />
            Infrastructure
          </Link>
        </nav>
