      ...
      >
        <div className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-surface p-4 rounded-xl border border-separator space-y-2">
              <div className="flex items-center justify-between">
          ...
          {order.delivery_address && (
            <div className="space-y-3">
              ...
              <div className="bg-surface p-4 rounded-xl border border-separator text-xs text-foreground leading-relaxed">
                {order.delivery_address}
              </div>
            </div>
          )}
          ...
          {(order.rider_name || order.courier_name || order.status === 'dispatched' || order.status === 'delivered') && (
            <div className="space-y-3">
              ...
              <div className="bg-surface p-4 rounded-xl border border-separator space-y-2 text-xs">
