...
import { bulkArchiveProducts, bulkDeleteProducts } from '@/app/actions/products';
          ...
          >
            ...
            <div className="flex items-center gap-1 sm:gap-2 shrink-0">
              ...
              <button 
                ...
                disabled={isUpdating}
                className="flex items-center gap-1.5 px-2 sm:px-3 py-1.5 text-xs font-semibold text-secondary hover:text-primary hover:bg-surface/50 rounded-full transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                title="Archive"
              >
