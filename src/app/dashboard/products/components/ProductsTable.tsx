                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="font-mono text-xs text-muted mt-0.5">#{product.id.substring(0, 8)}</div>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4 text-center">
                      {product.is_active ? (
                        ...
                        <span className="inline-flex items-center justify-center bg-surface-elevated text-secondary px-3 py-1 rounded-full text-xs font-semibold border border-separator">
                          Draft
                        </span>
                      )}
                    </td>
                    <td className="px-6 py-4 text-center">
                      <span className="inline-flex items-center justify-center bg-surface-elevated text-primary px-3 py-1 rounded-full text-xs font-semibold border border-separator">
                        {product.variants?.length || 0}
                      </span>
                    </td>
                    <td className="px-6 py-4 text-right">
                      <span className={`font-bold ${isOutOfStock ? 'text-error' : 'text-primary'}`}>
                        {totalStock}
                      </span>
                    </td>
                        ...
                        {activeMenuId === product.id && (
                          ...
                          >
                            <div className="p-1">
                              ...
                              <button onClick={() => { toast.info('Manage inventory coming soon!'); setActiveMenuId(null); }} className="w-full px-3 py-2 text-sm text-secondary hover:text-brand-primary hover:bg-surface-elevated rounded-lg flex items-center gap-2 transition-colors">
