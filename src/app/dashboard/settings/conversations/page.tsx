  ...
  return (
    <div className="max-w-3xl space-y-8 animate-fadeIn">
      <div>
        ...
        <p className="text-sm  mt-1">Manage how incoming customer chats are assigned and handled.</p>
      </div>
        ...
        <CardBody className="space-y-6">
          <div className="flex items-center justify-between py-2">
            <div className="space-y-1">
              <h4 className="text-sm font-medium">Auto-assign to staff</h4>
          ...
          <div className="flex items-center justify-between py-2">
            <div className="space-y-1">
              <h4 className="text-sm font-medium">Sticky Routing</h4>
              <p className="text-sm  max-w-lg">
      ...
      <Card>
        ...
        <CardBody className="space-y-6">
          <div className="flex items-center justify-between py-2 mb-2">
            <div className="space-y-1">
              <h4 className="text-sm font-medium">Enable SLA Tracking</h4>
            </div>
            <Switch defaultChecked={false} />
          </div>

          <div className="space-y-1.5 opacity-50 pointer-events-none">
            <label className="text-sm font-medium">Target Response Time</label>
            <select
              disabled
