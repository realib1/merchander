  ...
  return (
    <div className="max-w-3xl space-y-8 animate-fadeIn">
      <div>
        ...
        <p className="text-sm  mt-1">Manage what information is required during checkout.</p>
      </div>
        ...
        <CardBody className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs  mt-1">Customers must enter a valid phone number to complete purchase.</p>
            </div>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs  mt-1">Customers must enter an email to receive order confirmation.</p>
            </div>
            <Switch />
          </div>
        </CardBody>
        ...
        <CardBody className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs  mt-1">Digital products are sent immediately after successful payment.</p>
            </div>
            <Switch defaultChecked />
          </div>
        </CardBody>
      ...
      <Card className="border-destructive/30 bg-destructive/5">
        <CardHeader>
          ...
          <CardDescription className="text-destructive/80">
            Generate fake orders and customers for testing purposes.
          </CardDescription>
        </CardHeader>
        <CardBody>
          <p className="text-sm">
            This will populate your store with mock data. Useful for visualizing your dashboard before going live.
          </p>
        </CardBody>
