...
export default function FulfillmentSettingsPage() {
  return (
    <div className="max-w-3xl space-y-8 animate-fadeIn">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-text-primary">Fulfillment</h1>
        <p className="text-sm text-text-secondary mt-1">
          Configure how orders are packed and processed by your team.
        </p>
      </div>
        ...
        <CardBody className="space-y-6">
          <div className="flex items-center justify-between py-2">
            <div className="space-y-1">
              <h4 className="text-sm font-medium text-text-primary">Automatic Fulfillment</h4>
          ...
          <div className="flex items-center justify-between py-2">
            <div className="space-y-1">
              <h4 className="text-sm font-medium text-text-primary">Require Scanning</h4>
              <p className="text-sm text-text-secondary max-w-lg">
      ...
      <Card>
        ...
        <CardBody className="space-y-6">
          <div className="flex items-center justify-between py-2">
            <div className="space-y-1">
              <h4 className="text-sm font-medium text-text-primary">Show Prices</h4>
              <p className="text-sm text-text-secondary max-w-lg">
          ...
          <div className="flex items-center justify-between py-2">
            <div className="space-y-1">
              <h4 className="text-sm font-medium text-text-primary">Include Return Instructions</h4>
              <p className="text-sm text-text-secondary max-w-lg">
      ...
      <Card>
        ...
        <CardBody className="space-y-6">
          <div className="space-y-1.5">
            <label className="text-sm font-medium text-text-primary">Expected Processing Time</label>
            ...
            <p className="text-xs text-text-secondary mt-1">This expectation is shown to customers at checkout.</p>
          </div>
        </CardBody>
        <CardFooter className="justify-end border-t border-separator/50 mt-4">
