  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-100 p-8 text-center bg-surface border border-separator rounded-2xl shadow-sm m-4">
      ...
      <p className="mb-8 max-w-md">
        An unexpected error occurred in this section of the dashboard. Kindly{' '}
        <a href="mailto:[EMAIL_ADDRESS]" className="text-brand-primary hover:underline font-medium">
          contact support
        </a>{' '}
