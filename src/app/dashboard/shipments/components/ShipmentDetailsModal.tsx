...
export function ShipmentDetailsModal({ isOpen, onClose, shipment, onEdit }: ShipmentDetailsModalProps) {
  ...
  return (
      ...
      footer={
        <div className="flex items-center justify-between w-full">
          <div className="flex items-center gap-2">
            <span className="text-xs text-muted font-medium">Quick Advance:</span>
            {shipment.status === 'booked' && (
              <Button variant="outline" size="sm" onClick={() => handleStatusChange('in_transit')} className="text-xs">
                Mark In Transit
              </Button>
            )}
    ...
    >
      <div className="space-y-6">
        {/* Progress Stepper */}
        <div className="bg-surface-elevated/30 border border-separator rounded-2xl p-4">
