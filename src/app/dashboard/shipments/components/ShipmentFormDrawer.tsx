...
export interface ShipmentFormDrawerProps {
  isOpen: boolean;
  onClose: () => void;
...
function ShipmentFormContent({
  ...
  return (
    <form id="shipment-drawer-form" onSubmit={handleSubmit} className="space-y-6">
      <div>
        ...
        <input
          ...
          className="w-full text-sm rounded-xl bg-surface border border-separator px-3.5 py-2 text-foreground focus:ring-1 focus:ring-brand-primary focus:outline-none"
        />
      </div>
    ...
    <Drawer
      ...
      footer={
        <div className="flex items-center justify-end gap-3 w-full">
          ...
          <Button variant="primary" type="submit" form="shipment-drawer-form" disabled={isSubmitting}>
