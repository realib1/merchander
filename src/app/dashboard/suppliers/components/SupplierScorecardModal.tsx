...
export function SupplierScorecardModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs animate-fadeIn">
      <div className="bg-surface border border-separator rounded-2xl w-full max-w-lg overflow-hidden shadow-2xl animate-scaleIn">
        {/* Header */}
        <div className="flex items-center justify-between p-4 border-b border-separator bg-surface-elevated/30">
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-muted hover:bg-surface-elevated hover:text-foreground transition"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        {/* Footer */}
        <div className="p-4 border-t border-separator bg-surface-elevated/20 flex justify-end">
